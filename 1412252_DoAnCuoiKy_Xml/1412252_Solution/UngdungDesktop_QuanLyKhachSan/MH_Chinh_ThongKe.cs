...
{
    public partial class MH_Chinh_ThongKe : Form
    {
        enum LOAI_THONG_KE
        {
            Thang,
        ...
        static int ChiSo_ManHinhChucNang = 1;          //tab khu vực mà người dùng đang chọn hiển thị
        ...
        Form ManHinh_CapNhatGiaThue;        //Màn hình cập nhật giá thuê;
        ...
        private void KhoiDong()
        {
            ...
            ManHinh_CapNhatGiaThue = new MH_CapNhat_GiaThuePhong();
            ...
            DuLieu_NhiPhan = LuuTru.DocHinh("Update");
            TheHien.Xuat_Hinh(DuLieu_NhiPhan, btnCapNhat_DonGiaThue);
        ...
        private void VeBieu_ThongKeTongDoanhThu_Theo_Thang()
        {
            ...
            chartThang.Series[0].Points[0].LegendText = "Tiêu chuẩn";
            chartThang.Series[0].Points[0].SetValueY(DoanhThu_Loai1);
            chartThang.Series[0].Points[1].LegendText = "Cao cấp";
            chartThang.Series[0].Points[1].SetValueY(DoanhThu_Loai2);
            chartThang.Series[0].Points[2].LegendText = "Đặc biệt";
        ...
        private void VeBieu_ThongKeTongDoanhThu_Theo_Nam()
        {
            ...
            chartNam.Series[0].Points[0].LegendText = "Tiêu chuẩn";
            chartNam.Series[0].Points[0].SetValueY(DoanhThu_Loai1);
            chartNam.Series[0].Points[1].LegendText = "Cao cấp";
            chartNam.Series[0].Points[1].SetValueY(DoanhThu_Loai2);
            chartNam.Series[0].Points[2].LegendText = "Đặc biệt";
        ...
        //click button chuyển đổi giữa các panel hiển thị loại chức năng tra cứu, thống kê, cập nhật
        private void btnTraCuuPhieuThue_Click(object sender, EventArgs e)
        {
            Form MH_TraCuuPhieuThue = new MH_TraCuu_PhieuThuePhong();
            MH_TraCuuPhieuThue.Show();
        }
        ...
        private void btnCapNhat_DonGiaThue_Click(object sender, EventArgs e)
        {
            try
            {
                ManHinh_CapNhatGiaThue.Show();
            }
            catch(Exception ex)
            {
                ManHinh_CapNhatGiaThue = new MH_CapNhat_GiaThuePhong();
        ...
        private void MH_Chinh_ThongKe_Load(object sender, EventArgs e)
        {
            ...
            btnCapNhat_DonGiaThue.FlatStyle = FlatStyle.Flat;
            btnCapNhat_DonGiaThue.FlatAppearance.BorderSize = 0;
        ...
        private void MH_Chinh_ThongKe_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (CoDangXuat)
            {
